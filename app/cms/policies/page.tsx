...
function PolicyPage() {
  ...
  const policiesByType = policyTypes.map((type: Policy) => ({
    ...type,
    count: policies.filter((p: any) => p.policy_type_id === type.id).length,
  }));
        ...
        <Card className="bg-black/50 border-purple-500/30">
          <CardHeader>
            ...
            <CardDescription className="text-white/80">
              Hiển thị {paginatedPolicies.length} trên tổng số{" "}
