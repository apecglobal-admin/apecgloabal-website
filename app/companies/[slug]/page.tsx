              ...
              <div className="relative bg-white rounded-xl p-8 shadow-2xl">
                ...
                <div className="grid grid-cols-2 gap-6 mb-8">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-gray-900 font-medium">
                      {companyData.departments?.length || 0} phòng ban
                    </p>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-gray-900 font-medium">
                      {companyData.projectsCount || projects.length} dự án
                    </p>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-gray-900 font-medium">
                      {companyData.servicesCount || services.length} dịch vụ
                    </p>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-start space-x-3 group">
                      <div className="w-8 h-8 rounded-lg bg-white border border-purple-500/50 flex items-center justify-center flex-shrink-0 group-hover:border-cyan-500/30 transition-colors duration-300">
                    ...
                    <div className="flex items-start space-x-3 group">
                      ...
                      <div>
                        ...
                        <a
                          ...
                          className="text-gray-900 hover:text-red-600 transition-colors duration-300 flex items-center"
                        >
                ...
                <CardContent className="p-8 md:p-10">
                  ...
                  <div className="mt-16">
                    <div className="flex items-center mb-8">
                      ...
                      <h3 className="text-2xl font-bold bg-gradient-to-r from-purple-400 via-purple-400 to-cyan-400 bg-clip-text text-transparent">
                        Giá Trị Cốt Lõi
                      </h3>
                    </div>
                    ...
                    <div className="grid md:grid-cols-4 gap-6">
                      {coreValues.map((value, index) => (
                        <div
                          key={index}
                          className="group bg-white p-6 rounded-xl border border-purple-500/50 text-center hover:border-cyan-500/30 transition-all duration-300 hover:shadow-lg hover:shadow-purple-900/10"
                        >
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                      {achievements.map((achievement, index) => (
                        ...
                        >
                          ...
                          <div>
                            <p className="text-gray-800 text-lg group-hover:text-amber-600 transition-colors duration-300">
                              {achievement}
                            </p>
                          </div>
                        </div>
                        ...
                        <div className="grid md:grid-cols-3 gap-6">
                          {companyData.departments.map((department, index) => (
                            <div key={index} className="relative group">
                              ...
                              <div className="relative bg-white p-6 rounded-xl border border-purple-500/50 group-hover:border-cyan-500/30 transition-colors duration-300 backdrop-blur-sm shadow-md">
                ...
                <CardContent className="p-8 md:p-10">
                  ...
                  {projects.length > 0 ? (
                            ...
                            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                              <div className="flex-1">
                                ...
                                <Link href={`/projects/${project.slug}`}>
                                  <h4 className="text-xl font-medium text-gray-900 mb-2 group-hover:text-cyan-600 transition-colors duration-300">
                                    {project.name}
                                  </h4>
                                </Link>
                              ...
                              <div className="flex flex-col space-y-4 md:w-64">
                                <div className="space-y-2">
                                  ...
                                  <div className="w-full bg-gray-100 rounded-full h-2 overflow-hidden border border-purple-500/50">
                                    <div
                                      className={`bg-gradient-to-r ${getStatusGradient(
                                        project.status
                                ...
                                <Link href={`/projects/${project.slug}`}>
                                  <Button
                                    variant="outline"
                                    className="w-full text-red-600 border-red-200 hover:bg-red-50 hover:border-red-300 hover:text-black transition-all duration-300 group flex items-center justify-center space-x-2"
                                  >
                    ...
                    <div className="text-center py-12">
                      <div className="w-20 h-20 mx-auto rounded-full bg-gray-100 border border-purple-500/50 flex items-center justify-center mb-4">
                      ...
                      <p className="text-gray-600">
                        Công ty chưa có dự án nào được công bố.
                      </p>
                    </div>
                  )}
                </CardContent>
                                ...
                                service.features.length > 0 && (
                                  <div className="space-y-2 mb-6 text-left">
                                    ...
                                    {service.features.length > 3 && (
                                      <div className="text-cyan-600 text-sm text-center">
                                        + {service.features.length - 3} tính
                                        năng khác
                                      </div>
                                    )}
                                  </div>
                  ...
                  {employees && employees.length > 0 ? (
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                      {employees.map((employee) => (
                        <div
                          key={employee.id}
                          className="group relative p-6 bg-gradient-to-br from-white to-gray-50 rounded-xl border border-purple-500/50 hover:border-cyan-500/30 transition-all duration-500 hover:shadow-lg hover:shadow-purple-900/10 transform hover:-translate-y-1"
                        >
                          <div className="flex items-center mb-4">
          ...
          <div className="max-w-4xl mx-auto relative">
            ...
            <Card className="bg-white border-none shadow-2xl shadow-purple-900/20 backdrop-blur-md overflow-hidden">
              ...
              <CardContent className="p-12 text-center">
                ...
                <h2 className="text-4xl font-bold bg-gradient-to-r text-red-600 mb-6">
                  Bắt Đầu Hợp Tác Với {companyData.name}
                </h2>

                <p className="text-gray-600 text-lg mb-10 max-w-2xl mx-auto">
                  Liên hệ với chúng tôi ngay hôm nay để tìm hiểu thêm về các
                  dịch vụ và giải pháp AI tiên tiến mà{" "}
                  <span className="text-red-600 font-semibold">
                    {companyData.name}
                  </span>{" "}
                  có thể cung cấp cho doanh nghiệp của bạn.
                </p>
                ...
                <div className="flex flex-col sm:flex-row gap-6 justify-center">
                  ...
                  >
                    <Button
                      variant="outline"
                      className="text-red-600 hover:text-red-700 hover:bg-red-50 group"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="20"
