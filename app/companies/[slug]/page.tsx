      ...
      <section className="pt-8 px-4">
        <div className="container mx-auto">
          <div className="flex items-center text-white/60 text-sm">
            ...
            <Link href="/companies" className="hover:text-cyan-400 transition-colors duration-300">Công ty</Link>
            <span className="mx-2 text-purple-500/50">/</span>
            <span className="text-cyan-400/80 truncate max-w-[200px]">{companyData.name}</span>
          </div>
        </div>
      </section>
      
      {/* Company Header - AI Style */}
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              <div className="flex flex-wrap items-center gap-3 mb-2">
                <Badge className={`bg-gradient-to-r ${getStatusGradient(companyData.status)} px-3 py-1 text-xs font-medium uppercase tracking-wider`}>
                  {companyData.status}
                </Badge>
              ...
              <div className="flex items-center p-4 bg-black/30 rounded-xl border border-purple-500/20 backdrop-blur-sm">
                ...
                <div className="ml-4">
                  <p className="text-white/60 text-sm">Thành lập</p>
                ...
                <div className="grid grid-cols-2 gap-6 mb-8">
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="text-white/60 text-sm">Phòng ban</span>
                    </div>
                    <p className="text-white font-medium">{companyData.departments?.length || 0} phòng ban</p>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-white font-medium">{companyData.projectsCount || projects.length} dự án</p>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-white font-medium">{companyData.servicesCount || services.length} dịch vụ</p>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start space-x-3 group">
                      <div className="w-8 h-8 rounded-lg bg-black/30 border border-purple-500/20 flex items-center justify-center flex-shrink-0 group-hover:border-cyan-500/30 transition-colors duration-300">
                        <Mail className="h-4 w-4 text-cyan-400" />
                      </div>
                      <div>
                        <p className="text-white/60 text-sm">Email</p>
                        <a href={`mailto:${companyData.email}`} className="text-white hover:text-cyan-400 transition-colors duration-300">
                          {companyData.email}
                        </a>
                      </div>
                    </div>
        ...
        <div className="container mx-auto relative">
          <Tabs defaultValue="about" className="w-full">
            <div className="relative max-w-2xl mx-auto mb-12">
              ...
              <TabsList className="relative grid grid-cols-3 bg-black/60 border border-purple-500/30 rounded-full backdrop-blur-sm overflow-hidden">
                <TabsTrigger 
                  value="about" 
                  ...
                  <div className="mt-16">
                    ...
                    <div className="grid md:grid-cols-4 gap-6">
                      {coreValues.map((value, index) => (
                        <div key={index} className="group bg-black/30 p-6 rounded-xl border border-purple-500/20 text-center hover:border-cyan-500/30 transition-all duration-300 hover:shadow-lg hover:shadow-purple-900/10">
                          ...
                          <h3 className="text-white font-medium mb-2 group-hover:text-cyan-300 transition-colors duration-300">{value.title}</h3>
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                      {achievements.map((achievement, index) => (
                        <div key={index} className="flex items-start space-x-4 group">
                          ...
                          <div>
                            <p className="text-white/90 text-lg group-hover:text-amber-300 transition-colors duration-300">{achievement}</p>
                          </div>
                        </div>
                      ))}
                    </div>
                        ...
                        {companyData.departments.map((department, index) => (
                          <div key={index} className="relative group">
                            ...
                            <div className="relative bg-black/60 p-6 rounded-xl border border-purple-500/20 group-hover:border-cyan-500/30 transition-colors duration-300 backdrop-blur-sm">
                              <h4 className="text-white font-medium mb-2 group-hover:text-cyan-300 transition-colors duration-300">{department.name}</h4>
                ...
                <CardContent className="p-8 md:p-10">
                  ...
                  {projects.length > 0 ? (
                            ...
                            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                              <div className="flex-1">
                                ...
                                <Link href={`/projects/${project.slug}`}>
                                  <h4 className="text-xl font-medium text-white mb-2 group-hover:text-cyan-300 transition-colors duration-300">{project.name}</h4>
                                </Link>
                                ...
                                <div className="flex flex-wrap gap-2 mb-4">
                                  {project.technologies.map((tech, idx) => (
                                    <Badge 
                                      key={idx} 
                                      variant="outline" 
                                      className="border-cyan-500/30 text-cyan-300 bg-black/30 hover:bg-cyan-900/20 transition-colors duration-300 cursor-default flex items-center space-x-1 px-2 py-1"
                                    >
                                      {getTechIcon(tech)}
                                      <span>{tech}</span>
                                    </Badge>
                    ...
                    <div className="text-center py-12">
                      <div className="w-20 h-20 mx-auto rounded-full bg-black/30 border border-purple-500/20 flex items-center justify-center mb-4">
                        <FileText className="h-10 w-10 text-purple-400/50" />
                      </div>
                      <h4 className="text-xl font-medium text-white mb-2">Chưa có dự án nào</h4>
                      <p className="text-white/60">Công ty chưa có dự án nào được công bố.</p>
                    </div>
                  )}
                </CardContent>
              </Card>
                ...
                <CardContent className="p-8 md:p-10">
                  ...
                  {services.length > 0 ? (
                              ...
                              {service.features && service.features.length > 0 && (
                                <div className="space-y-2 mb-6 text-left">
                                  ...
                                  {service.features.length > 3 && (
                                    <div className="text-cyan-400 text-sm text-center">+ {service.features.length - 3} tính năng khác</div>
                                  )}
                                </div>
                              )}
                    ...
                    <div className="text-center py-12">
                      ...
                      <h4 className="text-xl font-medium text-white mb-2">Chưa có dịch vụ nào</h4>
                      <p className="text-white/60">Công ty chưa có dịch vụ nào được công bố.</p>
                    </div>
                  )}
                </CardContent>
              </Card>
